...
//!
//! Three slices so far. [`staking`] is share-price accounting only — see
...
//! changes them or schedules a fork. Governance is logic only — nothing
//! routes a transaction to it until the native module boundary exists.
//! Evidence and slashing aren't started yet.
