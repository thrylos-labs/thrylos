...
func main() {
	...
	dilithiumPrivateKeyBytes, _, _ := shared.GenerateDilithiumKeys()
	...
	transaction, err := shared.CreateAndSignTransaction("tx123", *sender, inputs, outputs, senderPrivateKey, dilithiumPrivateKeyBytes, aesKey)
	if err != nil {
