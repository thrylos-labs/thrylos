...
// 	OnNewBlock func(*shared.Block) // Callback function for when a new block is added
...
// func (bc *Blockchain) ProcessPendingTransactionsWithBatch(validator string, batch []*thrylos.Transaction) (*shared.Block, error) {
...
// func (bc *Blockchain) CreateUnsignedBlock(transactions []*thrylos.Transaction, validator string) (shared.Block, error) {
...
// func (bc *Blockchain) ProcessPendingTransactions(validator string) (*shared.Block, error) {
...
// func (bc *Blockchain) SimulateValidatorSigning(unsignedBlock *shared.Block) (*shared.Block, error) {
