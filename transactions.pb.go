...
type BlockResponse struct {
	...
	BlockData  string `protobuf:"bytes,1,opt,name=blockData,proto3" json:"blockData,omitempty"`    // This might contain the serialized block data
	BlockIndex int32  `protobuf:"varint,2,opt,name=blockIndex,proto3" json:"blockIndex,omitempty"` // Add this line to hold the index of the block
}
...
func (x *BlockResponse) GetBlockData() string {
	if x != nil {
		return x.BlockData
	}
	return ""
...
var file_transactions_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x44, 0x61, 0x74, 0x61, 0x12,
