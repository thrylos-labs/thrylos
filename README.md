...
**A Move-based proof-of-stake L1 written in Rust, optimised for auditability over feature count. Thrylos is pre-genesis where we are actively developing it. Contributers are welcome.**
